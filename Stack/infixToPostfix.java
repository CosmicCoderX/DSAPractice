...
public class infixToPostfix {
    ...
    public static String conversion(String str){
        ...
        Stack<String> val = new Stack<>();      // stack to store operands (as strings)
        ...
        for(int i = 0; i < str.length(); i++){
            ...
            // If character is digit → push to operand stack
            ...
            // If ')' → solve expression inside brackets
            else if(ch == ')'){
    ...
    public static void main(String[] args) {
        ...
        String[] Infix = {
                ...
                "3+4",              // simple addition
                "5+6*7",            // operator precedence
                "(2+3)*4",          // parentheses priority
                "8/4+2",            // division before addition
                "9-(3+2)*5",        // brackets + multiplication
                "7+8*(4-2)",        // nested operations
                "(6+3)*(2+1)",      // two bracket groups
                "9-4+3",            // left to right evaluation
                "8+6/3",            // division precedence
                "5+3*(8-6)/2"       // complex mixed expression
        };
